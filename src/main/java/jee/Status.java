...
public class Status implements StatusType {
  ...
  public final static int PASSWORD_TOO_SHORT = 8;//4 caractères minimum
  ...
  public String getReasonPhrase() {
    ...
    switch (code) {
      ...
      case USER_NO_ACCOUNT: str = " il faut + de 4 caratere et @"; break;
      ...
      case EMPTY_FIELD: str = "Nom ou Prénom  on nickname non renseigné"; break;
